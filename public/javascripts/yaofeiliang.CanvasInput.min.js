...
(function() {
  ...
  var CanvasInput = window.CanvasInput = function(o) {
    ...
    self.mousemove_EventListener=function(e) {
      e = e || window.event;
      self.mousemove(e, self);
    };

    self.mousedown_EventListener=function(e) {
      e = e || window.event;
      self.mousedown(e, self);
    };

    self.mouseup_EventListener=function(e) {
      e = e || window.event;
      self.mouseup(e, self);
    };
    if (self._canvas) {
      self._canvas.addEventListener('mousemove',self.mousemove_EventListener , false);

      self._canvas.addEventListener('mousedown', self.mousedown_EventListener, false);

      self._canvas.addEventListener('mouseup',self.mouseup_EventListener, false);
    }
    ...
    self._hiddenInput.addEventListener('mouseup', autoBlur, true);
    self._hiddenInput.addEventListener('touchend', autoBlur, true);
  ...
  CanvasInput.prototype = {
    removeEventListener:function(){
      var self = this;
      self._canvas.removeEventListener('mousemove',self.mousemove_EventListener , false);

      self._canvas.removeEventListener('mousedown', self.mousedown_EventListener, false);

      self._canvas.removeEventListener('mouseup',self.mouseup_EventListener, false);
